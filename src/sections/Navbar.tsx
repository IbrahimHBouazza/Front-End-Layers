        ...
        <>
            <section className="py-4 lg:py-8 fixed w-full top-0 z-50">
                <div className="container max-w-5xl">
                    <div className="border border-white/15 rounded-[27px] md:rounded-full md:pr-2 md:pl-3 bg-neutral-950/70 backdrop-blur">
                        <div className="grid grid-cols-2 lg:grid-cols-3 md:pr-2 items-center p-2 px-4 md:pl-4">
                            <div>
                                <img 
                                    src={logoImage.src} 
                                    alt="Layers Logo" 
